...
//Variables
 $lote = $_POST['Lote'];
 $descripcionLote = $_POST['Descripcion_Lote'];
 $cantidadElementos = $_POST['CT_Elementos_Lote'];
 $costoLote = $_POST['Costo_Lote'];
 $ubicacionLote = $_POST['Ubicacion_lote'];
 $caducidadLote = $_POST['Caducidad_lote'];
