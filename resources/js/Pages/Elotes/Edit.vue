            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900 dark:text-gray-100">
                        <form @submit.prevent="updateElote">
                            <div class="mb-4">
                            ...
                            <div class="mb-4">
                                ...
                                <input v-model="form.cantidad" type="number" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm dark:bg-gray-700" required />
                            </div>
