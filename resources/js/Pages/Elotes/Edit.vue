<template>
    ...
    <AuthenticatedLayout>
        <template #header>
            <h2 class="font-semibold text-3xl text-gray-800 dark:text-gray-900 leading-tight">Editar Elote</h2>
        </template>
...
const validateField = (field) => {
    switch (field) {
        ...
        case 'cantidad':
            ...
            break;
        case 'imagen':
            if (form.imagen && !form.imagen.cantidad <=0 ) {
                errors.value.imagen = 'La URL de la imagen no es válida.';
            } else {
                errors.value.imagen = '';
            }
            break;
